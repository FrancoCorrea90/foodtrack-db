...
El proyecto contempla la gestión de foodtrucks, productos, pedidos, ubicaciones y detalle de ítems pedidos, utilizando Microsoft SQL Server como motor de base de datos y DBeaver como cliente.
